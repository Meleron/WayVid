...
namespace WayVid.Migrations
{
    ...
    [Migration("20210511010341_AddVisitLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WayVid.Database.Entity.VisitLogItem", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VisitLogItem");
                });

            modelBuilder.Entity("WayVid.Database.Entity.Visitor", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("WayVid.Database.Entity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("WayVid.Database.Entity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WayVid.Database.Entity.User", b =>
                {
                    b.HasOne("WayVid.Database.Entity.Owner", "Owner")
                        .WithOne("User")
                        .HasForeignKey("WayVid.Database.Entity.User", "OwnerID");

                    b.HasOne("WayVid.Database.Entity.Visitor", "Visitor")
                        .WithOne("User")
                        .HasForeignKey("WayVid.Database.Entity.User", "VisitorID");
